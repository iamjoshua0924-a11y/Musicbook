...
router.get('/admin/me', requireLogin, async (req, res) => {
  ...
  res.json({
    ...
    user: {
      ...
      privateThemeCustomA: user.privateThemeCustomA || '#f2f3ff',
      privateThemeCustomB: user.privateThemeCustomB || '#ffffff',
      privateThemeCustomC: user.privateThemeCustomC || '#6b5bff',
